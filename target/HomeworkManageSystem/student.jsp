...
<div class="header" >
  <div class="main">
    <a  href="index.html"  style="margin-left: 30px;line-height: 65px; color: white;font-size: 18px;">作业在线管理系统</a>
    <div class="nav">
		...
		<ul class="layui-nav layui-nav-tree layui-inline" lay-filter="user">
			...
			<li class="layui-nav-item  "><a href="javascript:void(0)" onclick="updatePwd('修改密码',2)"> <i
					class="layui-icon">&#xe620;</i> 修改密码 </a></li>
						<li class="layui-nav-item "><a href="game.html" target="right"> <i
					class="layui-icon">&#xe61a;</i>小游戏 </a></li>
		...
		<div class="fly-panel fly-panel-user"  ">
			<div class="layui-tab layui-tab-brief" lay-filter="user">
				...
				<div class="layui-tab-content" style="padding: 20px;padding-top: 0px;">
    					...
    					<iframe src="welcome.html" width="88%" style="border: none;" height="800" border="none" name="right"></iframe>
					</div>					
				</div>
			</div>
		</div>
