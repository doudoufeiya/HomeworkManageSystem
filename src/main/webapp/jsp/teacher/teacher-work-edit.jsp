    ...
    <form action="addReadHomework.action" method="post" class="form form-horizontal" enctype="multipart/form-data"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="number" onkeyup="carNum($(this))" class="input-text" value="" placeholder="" id="sw_grade"
                       name="sw_grade"
                       datatype="*4-16" nullmsg="分数不能为空">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>批改意见：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="sw_remark" name="sw_remark"
                       datatype="*4-16">
            </div>
        </div>
        <div class="row cl">
