...
<div class="page-container container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        ...
        <a onclick="stu_add('添加资料','gotoResourcePage.action','800','500')"
    ...
    <c:if test="${resources != null}">
        ...
        <input type="hidden" id="pageSize" value="${resources.pageSize}">
        <input type="hidden" id="totalPage" value="${resources.totalPage}">
        <input type="hidden" id="totalRow" value="${resources.totalRow}">
    </c:if>
