...
<article class="page-container">
    <form action="answerQuestions.action" method="post" class="form form-horizontal"
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>回答内容：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="answer_content" name="answer_content"
                       datatype="*4-16" nullmsg="回答内容不能为空">
            </div>
        </div>
        <div class="row cl">
